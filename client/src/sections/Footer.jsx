  ...
  return (
    <footer style={{ textAlign: 'center', padding: '20px', backgroundColor: 'transparent' }}>
      <div className="flex">
        ...
        <a href="https://linkedin.com/in/shimwa-kelvin-4b0630297" target="_blank" rel="noopener noreferrer" style={{ margin: '0 10px', textDecoration: 'none', color: '#333' }}><img src="/linkedin.png" alt="social"/></a>
      </div>
